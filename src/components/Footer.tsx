  ...
  <footer id="footer-form" className="bg-foreground text-background pt-14 md:pt-20 pb-6">
    <div className="container px-4 grid lg:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <h2
          className="text-2xl md:text-4xl mt-2 mb-2 text-background"
          style={{ fontFamily: "Poppins, Inter, sans-serif" }}
        >
          Ready To Start? Let's Talk 📞
        </h2>

        <p className="text-background/70 mb-5">
          Fill the form, we'll call you within 30 minutes.
        </p>
      ...
      <div className="space-y-6 lg:pl-8">
        ...
        <div className="space-y-3 text-sm">
          ...
          <a
            href="mailto:pravreena2026@gmail.com"
            className="flex items-center gap-3 hover:text-accent transition-smooth"
          >
            <Mail className="h-4 w-4" />
            pravreena2026@gmail.com
          </a>
    ...
    <div className="container px-4 mt-12 pt-6 border-t border-background/10 text-center text-xs text-background/60">
      ...
      {/* 🔴 IMPORTANT: Google Ads Policy Disclaimer */}
      <p className="mb-3 max-w-3xl mx-auto leading-relaxed text-background/70">
        We are a private consultancy firm and are not affiliated with the Government of India or GST Department.
        We provide professional assistance for GST registration, filing and compliance services.
      </p>
