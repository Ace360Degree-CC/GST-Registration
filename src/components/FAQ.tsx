...
const faqs = [
  ...
  { q: "Pvt Ltd ya LLP — kaunsa choose karein?", a: "Pvt Ltd funding aur scaling ke liye best hai. LLP small partnerships ke liye zyada compliance-friendly hota hai. Hum aapki situation ke hisab se sahi structure suggest karte hain." },
  { q: "GST registration ka timeline kya hai?", a: "Documents complete hone ke baad usually 3–7 working days mein GSTIN mil jata hai." },
